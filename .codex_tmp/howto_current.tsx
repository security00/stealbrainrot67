        ...
        <div className="w-full max-w-4xl mx-auto">
          ...
          <section id="drop-rate" className="mb-10">
            ...
            <p className="text-gray-300 mb-3">
              ...
              around <strong>$7.5m per second</strong>. The reported <strong>drop rate</strong> is approximately
              <strong>0.25%</strong> and the item cost is around <strong>$1.2 billion</strong>.
            </p>
          ...
          </section><section id="faqs" className="mb-10">
